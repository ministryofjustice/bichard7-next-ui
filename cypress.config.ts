  ...
  e2e: {
    ...
    setupNodeEvents(on, _config) {
      on("task", {
        ...
        insertDummyCourtCaseWithLock(params: { errorLockedById: string; triggerLockedById: string; force: string }) {
          return insertDummyCourtCaseWithLock(params.errorLockedById, params.triggerLockedById, params.force)
        },
