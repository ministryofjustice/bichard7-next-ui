...
describe("PncException", () => {
  ;[
    ...
    it(`should show the PNC error code and message for exception ${code}${title ? ` (${title})` : ""}`, () => {
      ...
      if (message) {
        cy.get(".b7-accordion").should("exist")
        cy.get(".b7-accordion__content").should("not.exist")
        cy.get(".b7-accordion__button").should("have.text", "PNC error message").click()
        cy.get(".b7-accordion__content").should("exist")
        cy.get(".b7-accordion__content .b7-inset-text__heading").should("have.text", "PNC error message")
        cy.get(".b7-accordion__content .b7-inset-text__content").should("have.text", expectedMessage)
        cy.get(".b7-accordion__button").should("have.text", "PNC error message").click()
        cy.get(".b7-accordion__content").should("not.exist")
      } else {
