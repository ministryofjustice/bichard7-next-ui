...
type TriggerWithCount = Partial<DisplayPartialTrigger> & { count: number }

const triggersWithCounts = (triggers: DisplayPartialTrigger[]) => {
...
export const TriggersReasonCell = ({ triggers }: { triggers: DisplayPartialTrigger[] }) => {
  return (
    <>
