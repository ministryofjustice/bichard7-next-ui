...
enum ErrorMessages {
  ...
  HO100228 = "Go back to Legacy bichard, fix it and resubmit. Manual sequence number is invalid (i.e. it is not a number)",
  ...
  HO100312 = "Go back to Legacy bichard, fix it and resubmit. Manual sequence number does not match the sequence number of any PNC offence",
  HO100320 = "Go back to Legacy bichard, fix it and resubmit. Manual sequence number identifies an offence that matches a PNC offence but doesn’t match a court offence (i.e. the offence code or dates do not match correctly",
