enum ErrorMessages {
	...
	AsnUneditable = "This code could not be recognised, as the PNC cannot be updated automatically because there are changes to existing disposals together with sentencing. Resolve exception by manually updating the PNC with correct code."
}
