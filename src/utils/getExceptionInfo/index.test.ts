import getExceptionInfo from "."

describe("getExceptionInfo", () => {
  it("should return the exception info when exception code exists", () => {
    const result = getExceptionInfo("HO100301")
    expect(result).toStrictEqual({
      title: "ASN not found on PNC",
      description:
  ...
  it("should return undefined when exception code exists", () => {
    const result = getExceptionInfo("HO900900")
