...
import { Table, Tabs } from "govuk-react"
...
const HearingOutcome: React.FC<Props> = ({ aho }) => {
  ...
  return (
    <Tabs>
      <Tabs.List>
        <Tabs.Tab href="#0" onClick={() => setCurrentTab(0)} selected={currentTab === 0}>
          {"Hearing"}
        </Tabs.Tab>
        <Tabs.Tab href="#1" onClick={() => setCurrentTab(1)} selected={currentTab === 1}>
          {"Case"}
        </Tabs.Tab>
        <Tabs.Tab href="#2" onClick={() => setCurrentTab(2)} selected={currentTab === 2}>
          {"Defendant"}
        </Tabs.Tab>
        <Tabs.Tab href="#3" onClick={() => setCurrentTab(3)} selected={currentTab === 3}>
          {"Offences"}
        </Tabs.Tab>
      </Tabs.List>
      <Tabs.Panel id="0" selected={currentTab === 0}>
        <Table
          head={
            <Table.Row>
      ...
      <Tabs.Panel id="1" selected={currentTab === 1}>
        <Table
          head={
            <Table.Row>
              <Table.CellHeader>{"Name"}</Table.CellHeader>
      ...
      <Tabs.Panel id="2" selected={currentTab === 2}>
        <Table
          head={
            <Table.Row>
              <Table.CellHeader>{"Name"}</Table.CellHeader>
        ...
        >
          ...
          <Table.Row>
            ...
            <Table.Cell>
              {aho.AnnotatedHearingOutcome.HearingOutcome.Case.HearingDefendant.DefendantDetail?.BirthDate instanceof
              Date
          ...
          <Table.Row>
            ...
            <Table.Cell>
              {aho.AnnotatedHearingOutcome.HearingOutcome.Case.HearingDefendant.Address.AddressLine1}
            </Table.Cell>
          </Table.Row>
          <Table.Row>
            <Table.Cell>{"Address line 2"}</Table.Cell>
            <Table.Cell>
              {aho.AnnotatedHearingOutcome.HearingOutcome.Case.HearingDefendant.Address.AddressLine2}
            </Table.Cell>
          </Table.Row>
          <Table.Row>
      ...
      <Tabs.Panel id="3" selected={currentTab === 3}>
        <Table
          head={
            <Table.Row>
